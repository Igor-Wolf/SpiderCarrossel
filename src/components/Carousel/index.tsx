...
export default function Carousel({ heroes, activeId }: IProps) {
    ...
    useEffect(() => {
        ...
        if (isMobile) {
            htmlEl.style.backgroundSize = "100% 200vh";
        }
    ...
    // -1 rotaciona no sentido anti-horario
    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <motion.div className={styles.details}
                ...
                <HeroDetails data={visibleItems[enPosition.MIDDLE]}></HeroDetails>
...
const getItemStyles = (position: enPosition) => {
    ...
    const isMobile = typeof window !== "undefined" && window.innerWidth <= 480;
    const isTablet = typeof window !== "undefined" && window.innerWidth <= 1500 && window.innerWidth > 480;
